...
# from pipe.tools.project import model
...
# from pipe.tools.project.record import History
...
crackerjack (also crackajack), dab [chiefly British], 
dab hand [chiefly British], expert, fiend, geek, guru, 
hand, hotshot, maestro, master, maven (also mavin), meister, 
past master, proficient, scholar, shark, sharp, virtuoso, whiz, wizard
pro, professional, specialist, technician
...
craftsman, craftsperson, craftswoman, journeyman
    ...
    def createOrUpdate(self, all, create):
        ...
        for index, history in enumerate(histories):
            ...
            try:
                ...
                valid, message = False, str(error), None
            QtWidgets.QApplication.restoreOverrideCursor()
            if not valid:
                QtWidgets.QMessageBox.warning(
                    self, "Warning", message, QtWidgets.QMessageBox.Ok
